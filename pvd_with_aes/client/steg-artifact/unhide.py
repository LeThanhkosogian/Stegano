...
import numpy as np
from PIL import Image
from decryptAES import decrypt_message
...
if __name__ == "__main__":
    image_path = input("Nhập đường dẫn đến ảnh chứa thông điệp: ")
    # image_path = "C:\\Users\\Admin\\Desktop\\Stegano\\temp\\pvd_with_aes\\server\\steg.png"
    encrypted_message = unhide_message_in_image(image_path)
    print(f"Encrypted message was hidden in the image: {encrypted_message}")
    password = input("Nhập mật khẩu để giải mã: ")
    decrypt_message = decrypt_message(encrypted_message, password)
